...
print (" ________ _____________________ _____________________ _____________________ _________________ _______________ ")
while True:
  try:
...
print ("|  max gyro  |  x: {0:5.1f}\u00b0  |  y: {1:5.1f}\u00b0  |  z: {2:5.1f}\u00b0  |".format(highgyrox, highgyroy, highgyroz))
